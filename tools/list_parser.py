...
if __name__ == '__main__':
    ...
    with codecs.open(file_path, "r", "utf-8") as f:
        for line in f:
            ...
            content = content + u"        <areaId type=\"String\"><![CDATA[%s]]></areaId>\n" % area_id
            content = content + u"        <uri type=\"String\"><![CDATA[%s]]></uri>\n" % uri
            content = content + u"        <name type=\"com.kaixindev.core.I18NString\">\n"
            content = content + u"            <en type=\"String\"><![CDATA[%s]]></en>\n" % name_en
            content = content + u"            <zh type=\"String\"><![CDATA[%s]]></zh>\n" % name_zh
